...
''' ==================== imports ==================== '''
# from  import * # Helper libraries
# import  # saving the model
''' ================================================= '''



''' =================== Load Data =================== '''
# dtf = pd.read_csv("") # load 'data_houses.csv'
...
''' =================== Format Data ================= '''
# dtf = dtf.set_index() # Set the index column of the pandas data frame
...
# dtf_train, dtf_test = dtf_partitioning(dtf, y="Y", test_size=, shuffle=False) # Split into training and test 70/30
''' ================================================= '''
...
# scalerX = preprocessing.RobustScaler(quantile_range=(,)) # Scale data to quantile range 25, 75
# scalerY = preprocessing.RobustScaler(quantile_range=(,)) # Scale data to quantile range 25, 75
#
...
# 
# #--- selection ---#
# X_names = [] # choose the most correlated columns
#
...
#
# model = tune_regr_model(X_train, y_train, model, param_dic, scoring="r2",searchtype="RandomSearch", n_iter=?, cv=5, figsize=(10,?)) # set the model size
...
''' ============= Evaluate The model ================ '''
# model, predicted = fit_ml_regr() # Predict the test data
#
# evaluate_regr_model(y_test, predicted, figsize=(25,?)) # Evaluate the predictions
# i = 1
